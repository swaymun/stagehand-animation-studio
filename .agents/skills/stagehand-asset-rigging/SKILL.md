...
description: Build, inspect, correct, approve, animate, and export production-ready segmented 2D character rigs in Stagehand. Use for generated or uploaded character art, StagehandAssetPackageV2 manifests, skeleton and binding review, rendered seam or stress-pose QA, variant compatibility, provenance, and recovery from failed candidates or stale revisions.
---
...
2. Call `get_asset_generation_checklist` before generating or revising media, then create a durable request with `create_asset_request`.
...
7. Prefer segmented 2D binding for production. Label mesh binding experimental and keep a segmented fallback.
