...
story = [
    ...
    p("Current checkpoint: public Site v77, verified 2026-09-03.", subtitle),
    p("Project", heading),
    ...
    p("Private source: github.com/swaymun/stagehand-animation-studio<br/>Commit: 430b7a687962be8c58695ad64f5ab1ee45a1a31d<br/>Public Site: stagehand-animation-studio.saimun-h-shahee.chatgpt.site<br/>Sites version: 77", body),
    ...
    *bullets([
    ...
    p("Local and hosted smoke passed: 51 tools, 38 guarded mutations, stale-write conflict, idempotent replay, frame and PNG export, wide pose-sheet detection, asset-style parity, prop animation, undo/redo, two-scene WebM, sequence Preview transition, Help modal semantics, reload recovery, and zero page errors.", body),
    PageBreak(),
]

screens = [
    ("Animate editing workspace", "v77-animate.png", "Hosted Playwright capture at 1440 x 960. Motion actions identify their target character and duration; the scene label remains readable."),
    ("Assets style editor", "v77-assets-style.png", "Hosted Playwright capture at 1440 x 960. The expandable Style control exposes structured visual direction without taking over the asset rail."),
    ("Storyboard mode with Board rail", "v77-storyboard.png", "Hosted Playwright capture at 1440 x 960. The selected top-level mode and project rail stay synchronized."),
    ("Review-first Preview player", "v77-preview.png", "Hosted Playwright capture at 1440 x 960. Scene-only context, transport, and Exit preview remain; global editing controls are hidden."),
]
